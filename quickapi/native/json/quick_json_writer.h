...
QUICKAPI_EXPORT quickapi_result quickapi_json_writer_success_into(quickapi_buffer* buffer, int status, const char* code, const char* message, const char* data_json);
